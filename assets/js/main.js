(function() {
  ...
  function setContactEmail() {
    document.getElementById("contact-email").href = "mailto:robotics@sjci.com"
  }
  setContactEmail();
  ...
  (function() {
    ...
    var WAIT_TIME = 5;
    var seconds = 0;
    //var buttonGroup = $('#contact-button-group');

    var timer = setInterval(function() {
      $message._info('You can submit in ' + (WAIT_TIME - seconds) + ' seconds.');
      seconds++;
